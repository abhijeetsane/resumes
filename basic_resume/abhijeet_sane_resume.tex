...
\firstname{Abhijeet}
\lastname{Sane}
\quote{\itshape Programmer with good understanding of Unix Kernel architecture, application analysis and design on Linux, Unix platforms using C / C++ / NodeJS / Python / Perl. Good communication skills and capacity to work as a team player.}

\setcvasset[0]{\emph{Technology Specialist}}
\setcvcontact[email]{abhijeet.sane@gmail.com} 

\setcvcontact[cellphone]{+1 404-563-4053}
\setcvcontact[skype]{abhijetsane} 
\setcvcontact[linkedin]{abhijeetsane}
\setcvcontact[spokenlanguages]{English,Marathi,Hindi,Gujarati} 
\setcvcontact[age]{October 18th 1978} 
\setcvcontact[address]{4105 Cypress Court\\Alpharetta\\GA 30005} 
\pdfminorversion=5
\pdfcompresslevel=9 
...
\begin{skills}{}
      \skill[Programming Languages   ]{   C , C++ , Knowledge of Java }
      ...
      \skill[Cloud Technologies   ] {   Citrix Xen , Amazon EC2}
      \skill[Database   ] {   MySQL , RethinkDB}
      \skill[Caching   ] {   Redis}
      \skill[Job Server  ] {   Gearman job server}
      \skill[Gui  ] {   QT Toolkit , Python/Tk} 
\end{skills}


\section{Work Experience}
\story{Onsite Lead - Coordinator}{Cognizant Technology Solutions}{March 31 2015 - May 2015 \\ Atlanta , GA}
{Languages / Technologies \\ NodeJS/Perl/Python/Redis/Linux}
	...
	\begin{missions}
		...
		\item Coordinating with onsite and offshore teams . Resolving technical issues.
