...
\story{Technology Architect}{Kohls - Cognizant Technology Solutions}{Aug 2018 - Current Date  \\ Pune ,MH , India}
{Languages / Technologies \\Python,R}
	{ 
	\begin{missions}
		\item Architect for implementing the Cognizant SmartAPM solution for Kohls US.
		\item Implemented and designed a metric collector to collect KPI data from Kohls Splunk and push the KPI data to Influx DB in SmartAPM consumable form.
		\item Automated the data loaders and AI bots batch execution scheduling.
        \item Integrated SmartAPM with ServiceNow for automated ticket generation.
	\end{missions}
}
